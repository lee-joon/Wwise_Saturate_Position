...
#ifndef pos_SatFXParams_H
#define pos_SatFXParams_H
...
static const AkPluginParamID PARAM_DISTANCE_ID = 0;
static const AkPluginParamID PARAM_SATURATE_ID = 1;
static const AkUInt32 NUM_PARAMS = 2;

struct pos_SatRTPCParams
{
    
};

struct pos_SatNonRTPCParams
{
    AkReal32 Distance;
    AkReal32 Param;
};

struct pos_SatFXParams
    : public AK::IAkPluginParam
{
    pos_SatFXParams();
    pos_SatFXParams(const pos_SatFXParams& in_rParams);
    ...
    pos_SatRTPCParams RTPC;
    pos_SatNonRTPCParams NonRTPC;
};

#endif // pos_SatFXParams_H
